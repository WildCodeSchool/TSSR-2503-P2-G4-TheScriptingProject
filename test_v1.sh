...
#Fontion script général à ajouter()


#######################################################################################################################
#              Plan de script                                                                                         
######################################################################################################################
#            1) Déclation de toutes les fonctions 
#            2) Déclaration de la fonction menu_admin qui sert a rappeler toutes les fonctions dans le admin_menu
#            2) Script sélection du client cible et connexion ssh -t --> lancement de la fonction admin_menu_dans ssh
#            
#######################################################################################################################
...
########################################################################################################################################""
################    2) Déclaration de la fonction menu_admin qui sert a rappeler toutes les fonctions dans un menu   ###############
#########################################################################################################################################
...
#lancer la connexion
    ...
    #copie du script dans la commande ssh
     ssh -t "$user@$ip" "$(cat admin_script.sh); admin_menu" 2>&1
    ...
    #rajouter ici la fonction qui lance le  menu_général
    admin_menu
